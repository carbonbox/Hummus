...
web build:
 - http://mootools.net/core/7dd53996eb302f41eeb4f4a903664ec2

packager build:
 - packager build Core/Core Core/Array Core/String Core/Number Core/Function Core/Element.Dimensions Core/Fx.Tween Core/Fx.Morph Core/Fx.Transitions Core/Request.HTML Core/Request.JSON Core/Cookie Core/JSON Core/DOMReady
...
},periodical:function(c,b,a){return setInterval(this.pass(a,b),c);}});(function(){var k=this.document;var i=k.window=this;var b=1;this.$uid=(i.ActiveXObject)?function(e){return(e.uid||(e.uid=[b++]))[0];
